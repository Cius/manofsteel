 ...
 * /WEB-INF/pages/sec_right/jenjangPendidikanDialog.zul file.<br>
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 * 
 ...
 * @author sgerth
 */
public class JenjangPendidikanDialogCtrl extends GFCBaseCtrl implements Serializable {

	private static final long serialVersionUID = -3989381318982978024L;

	private static final Logger logger = Logger.getLogger(JenjangPendidikanDialogCtrl.class);
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 */
	protected Window jenjangPendidikanDialogWindow; // autowired
	protected Textbox tb_Kode;
	protected Textbox tb_JenjangPendidikan;
	protected Listbox dd_Gawal;
	protected Listbox dd_Gakhir;

	// overhanded vars per params
	private transient Listbox listBoxJenjangPendidikan; // overhanded
	private Dikum jenjangPendidikan;

	// old value vars for edit mode. that we can check if something
	// on the values are edited since the last init.
	private transient String oldVar_Kode;
	private transient String oldVar_JenjangPendidikan;
	...
	private transient final String btnCtroller_ClassPrefix = "button_JenjangPendidikanDialog_";
	 ...
	 */
	public JenjangPendidikanDialogCtrl() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$jenjangPendidikanDialogWindow(Event event) throws Exception {
		...
		if (args.containsKey("jenjangPendidikan")) {
			setJenjangPendidikan((Dikum) args.get("jenjangPendidikan"));
		} else {
		...
		GolonganRuang typ = jenjangPendidikan.getGawal();
		ListModelList lml2 = (ListModelList) dd_Gakhir.getModel();
		GolonganRuang typ2 = jenjangPendidikan.getGakhir();

		if (jenjangPendidikan.isNew()) {
		...
		// delete users here.
		if (args.containsKey("listBoxJenjangPendidikan")) {
			listBoxJenjangPendidikan = (Listbox) args.get("listBoxJenjangPendidikan");
		} else {
			listBoxJenjangPendidikan = null;
		}

		// set Field Properties
		doSetFieldProperties();

		doShowDialog(getJenjangPendidikan());
	 ...
	 * @throws Exception
	 */
	public void onClose$jenjangPendidikanDialogWindow(Event event) throws Exception {
...
//	}
	...
	public void onClick$btnClose(Event event) throws InterruptedException {
		...
		try {
			...
			// close anyway
			jenjangPendidikanDialogWindow.onClose();
		}
	}
	 ...
	 *            JenjangPendidikan
	 */
	public void doWriteBeanToComponents(Dikum jenjangPendidikan) {
		tb_Kode.setValue(jenjangPendidikan.getKjur());
		tb_JenjangPendidikan.setValue(jenjangPendidikan.getNjur());
	 ...
	 * @param aRight
	 */
	public void doWriteComponentsToBean(Dikum jenjangPendidikan) {
		jenjangPendidikan.setKjur(tb_Kode.getValue());
		jenjangPendidikan.setNjur(tb_JenjangPendidikan.getValue());
	}
	 ...
	 * @throws InterruptedException
	 */
	public void doShowDialog(Dikum jenjangPendidikan) throws InterruptedException {
		...
		try {
			...
			doWriteBeanToComponents(jenjangPendidikan);

			// stores the inital data for comparing if they are changed
			// during user action.
			doStoreInitValues();

			jenjangPendidikanDialogWindow.doModal(); // open the dialog in modal
			// mode
		} catch (final Exception e) {
	...
	private void doSetFieldProperties() {
		...
		tb_JenjangPendidikan.setMaxlength(100);
	}
	...
	private void doStoreInitValues() {
		...
		oldVar_JenjangPendidikan = tb_JenjangPendidikan.getValue();
	...
	private void doResetInitValues() {
		...
		tb_JenjangPendidikan.setValue(oldVar_JenjangPendidikan);
	...
	private boolean isDataChanged() {
		...
		if (oldVar_JenjangPendidikan != tb_JenjangPendidikan.getValue()) {
			changed = true;
		}
	...
	private void doSetValidation() {
		...
		tb_JenjangPendidikan.setConstraint("NO EMPTY");
	}
	...
	private void doRemoveValidation() {
		...
		tb_JenjangPendidikan.setConstraint("");
	}
	...
	/**
	 * Deletes a jenjangPendidikan object from database.<br>
	 * 
	 * @throws InterruptedException
	 */
	private void doDelete() throws InterruptedException {

		final Dikum gol = getJenjangPendidikan();
		...
		if (MultiLineMessageBox.show(msg, title, MultiLineMessageBox.YES | MultiLineMessageBox.NO, MultiLineMessageBox.QUESTION, true, new EventListener() {
			...
			private void delete() throws InterruptedException {
				...
				final ListModelList lml = (ListModelList) listBoxJenjangPendidikan.getListModel();
				...
				jenjangPendidikanDialogWindow.onClose(); // close
			}
		}
	...
	/**
	 * Create a new jenjangPendidikan object. <br>
	 */
	private void doNew() {
		...
		// We don't create a new DomainObject() in the frontend.
		// We GET it from the backend.
		setJenjangPendidikan(getDikumDAO().getNewDikum());
	...
	public void doReadOnly() {
		...
		tb_JenjangPendidikan.setReadonly(true);
	...
	public void doSave() throws InterruptedException {
		...
		// now synchronize the listBox
		ListModelList lml = (ListModelList) this.listBoxJenjangPendidikan.getListModel();
	...
	public Dikum getJenjangPendidikan() {
		return jenjangPendidikan;
	}

	public void setJenjangPendidikan(Dikum jenjangPendidikan) {
