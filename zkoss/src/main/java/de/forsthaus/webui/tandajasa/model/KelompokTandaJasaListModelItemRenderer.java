 ...
 */
package de.forsthaus.webui.tandajasa.model;
 ...
 * 
 */
public class KelompokTandaJasaListModelItemRenderer implements ListitemRenderer, Serializable {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(KelompokTandaJasaListModelItemRenderer.class);
	...
	public void render(Listitem item, Object data) throws Exception {
		...
		final Gabungan gabungan = (Gabungan) data;
		Listcell lc;

		lc = new Listcell(gabungan.getKode());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		lc = new Listcell(gabungan.getNama());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		item.setAttribute("data", data);
		ComponentsCtrl.applyForward(item, "onDoubleClick=onDoubleClickedKelompokTandaJasaiItem");
