 ...
 * 
 */
public class JenisTandaJasaListModelItemRenderer implements ListitemRenderer, Serializable {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(JenisTandaJasaListModelItemRenderer.class);
	...
	public void render(Listitem item, Object data) throws Exception {
		...
		ComponentsCtrl.applyForward(item, "onDoubleClick=onDoubleClickedJenisTandaJasaItem");
