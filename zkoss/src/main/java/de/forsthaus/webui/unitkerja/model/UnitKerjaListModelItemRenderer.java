 ...
 * 
 */
public class UnitKerjaListModelItemRenderer implements ListitemRenderer, Serializable {
	...
	public void render(Listitem item, Object data) throws Exception {
		...
		Wilayah wilayah = getWilayahDAO().getWilayahByKode(unitKerja.getKlokasi() + "0000");
		lc = new Listcell(wilayah.getNamaWilayah());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		item.setAttribute("data", data);
		ComponentsCtrl.applyForward(item, "onDoubleClick=onDoubleClickedUnitKerjaItem");
