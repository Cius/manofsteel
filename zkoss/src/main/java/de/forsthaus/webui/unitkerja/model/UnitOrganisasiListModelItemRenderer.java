 ...
 * 
 */
public class UnitOrganisasiListModelItemRenderer implements ListitemRenderer, Serializable {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(UnitOrganisasiListModelItemRenderer.class);
	...
	public void render(Listitem item, Object data) throws Exception {
		...
		final UnitKerja unitOrganisasi = (UnitKerja) data;
		Listcell lc;

		lc = new Listcell(unitOrganisasi.getKunker());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		lc = new Listcell(unitOrganisasi.getNunker());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		item.setAttribute("data", data);
		ComponentsCtrl.applyForward(item, "onDoubleClick=onDoubleClickedUnitOrganisasiItem");
