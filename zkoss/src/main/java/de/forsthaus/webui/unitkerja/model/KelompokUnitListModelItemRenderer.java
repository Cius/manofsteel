 ...
 * 
 */
public class KelompokUnitListModelItemRenderer implements ListitemRenderer, Serializable {
	...
	public void render(Listitem item, Object data) throws Exception {
		...
		lc = new Listcell(unitKerja.getKpok());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);
		
		lc = new Listcell(unitKerja.getNpok());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);
		

		item.setAttribute("data", data);
		ComponentsCtrl.applyForward(item, "onDoubleClick=onDoubleClickedKelompokUnitItem");
