 ...
 * 
 */
public class JenisHukumanRinganListModelItemRenderer implements ListitemRenderer, Serializable {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(JenisHukumanRinganListModelItemRenderer.class);
	...
	public void render(Listitem item, Object data) throws Exception {
		...
		final Gabungan jenisHukumanRingan = (Gabungan) data;
		Listcell lc;

		lc = new Listcell(jenisHukumanRingan.getKode());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		lc = new Listcell(jenisHukumanRingan.getNama());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		item.setAttribute("data", data);
		ComponentsCtrl.applyForward(item, "onDoubleClick=onDoubleClickedJenisHukumanRinganItem");
