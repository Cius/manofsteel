 ...
 * 
 */
public class JenisNaikPangkatListModelItemRenderer implements ListitemRenderer, Serializable {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(JenisNaikPangkatListModelItemRenderer.class);
	...
	public void render(Listitem item, Object data) throws Exception {
		...
		final Gabungan jenisNaikPangkat = (Gabungan) data;
		Listcell lc;

		lc = new Listcell(jenisNaikPangkat.getKode());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		lc = new Listcell(jenisNaikPangkat.getNama());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		item.setAttribute("data", data);
		ComponentsCtrl.applyForward(item, "onDoubleClick=onDoubleClickedJenisNaikPangkatItem");
