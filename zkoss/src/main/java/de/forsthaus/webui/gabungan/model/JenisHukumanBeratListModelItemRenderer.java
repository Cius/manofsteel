 ...
 * 
 */
public class JenisHukumanBeratListModelItemRenderer implements ListitemRenderer, Serializable {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(JenisHukumanBeratListModelItemRenderer.class);
	...
	public void render(Listitem item, Object data) throws Exception {
		...
		final Gabungan jenisHukumanBerat = (Gabungan) data;
		Listcell lc;

		lc = new Listcell(jenisHukumanBerat.getKode());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		lc = new Listcell(jenisHukumanBerat.getNama());
		lc.setStyle("padding-left: 5px");
		lc.setParent(item);

		item.setAttribute("data", data);
		ComponentsCtrl.applyForward(item, "onDoubleClick=onDoubleClickedJenisHukumanBeratItem");
