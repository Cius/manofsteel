...
public class Report14DaftarJabatanStrukturalBelumDiklatpimCtrl extends GFCBaseCtrl implements Serializable {
	...
	String [] arrEselon = {"IIA"};
	String [] arrKodeEselon = {"21"};

	private TbMasterDAO TbMasterDAO;
	private MasterUnitKerjaDAO masterUnitKerjaDAO;

	public Report14DaftarJabatanStrukturalBelumDiklatpimCtrl() {
		super();
	}
	...
	public void onClick$btnCari(Event event) throws InterruptedException {
		...
		listTbMaster = TbMasterDAO.getDaftar14JabatanStrukturalBelumDiklatpim(criterias);
		...
		report.setSrc("/reports/14daftar_jabatan_struktural_belum_diklatpim.jasper");
	...
	private String composeTitle() {
		...
		title +="YANG TELAH MENDUDUKI JABATAN STRUKTURAL ";
		title +=arrEselon[iEselon];
		title +="<br/>";
		title +="DAN BELUM MENGIKUTI DIKLATPIM ";
		title +=arrEselon[iEselon];
