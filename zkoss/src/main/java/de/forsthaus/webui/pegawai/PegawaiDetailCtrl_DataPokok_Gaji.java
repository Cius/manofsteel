...
public class PegawaiDetailCtrl_DataPokok_Gaji extends GFCBaseCtrl implements Serializable {
	...
	public PegawaiDetailCtrl_DataPokok_Gaji() {
		super();
	}
	...
	public void doAfterCompose(Component component) throws Exception {
		...
		if (this.arg.containsKey("ModuleMainController")) {
			...
			getPegawaiDetailCtrl_DataPokok().setPegawaiDetailCtrl_DataPokok_Gaji(this);
