...
public class PegawaiDetailCtrl_RiwayatPengangkatan_LN extends GFCBaseListCtrl<TrMutasi> implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(PegawaiDetailCtrl_RiwayatPengangkatan_LN.class);

	protected Window windowPegawaiDetail_RiwayatPengangkatan_LN;
	...
	private TrMutasi selectedPangkat;

	private AnnotateDataBinder binder;
	private PegawaiDetailCtrl_RiwayatPengangkatan pegawaiDetailCtrl_RiwayatPengangkatan;
	
	private TrMutasiDAO trMutasiDAO;
	private HibernateSearchObject<TrMutasi> searchObj;

	public PegawaiDetailCtrl_RiwayatPengangkatan_LN() {
		super();
	}
	...
	public void doAfterCompose(Component component) throws Exception {
		...
		if(arg.containsKey("ModuleMainController")) {
			...
			getPegawaiDetailCtrl_RiwayatPengangkatan().setPegawaiDetailCtrl_RiwayatPengangkatan_LN(this);
	...
	public void onCreate$windowPegawaiDetail_RiwayatPengangkatan_LN(Event event) {
...
//		listBox_jabatan.setItemRenderer(new RiwayatMutasiListModelItemRenderer());
	...
	public void doFillList() {
		...
		searchObj = new HibernateSearchObject<TrMutasi>(TrMutasi.class, getCountRows());
		...
		setRiwayatPengangkatanModelList_LN(lml);
		...
		if (getSelected() == null) {
			...
			if (lml.getSize() > 0) {
				...
				TrMutasi selectedPangkat = (TrMutasi) lml.get(0);
	...
	public void onDoubleClicked(Event event) throws InterruptedException {
		...
		TrMutasi jabatan = getSelectedPangkat();
		...
		if (jabatan != null) {
			...
			try {
				Executions.createComponents("/WEB-INF/pages/pegawai/pegawaiDetail_RiwayatPengangkatan_LNDialog.zul", null, map);
	...
	public void doFitSize() {
		...
		windowPegawaiDetail_RiwayatPengangkatan_LN.invalidate();
	}
	...
	public BindingListModelList getRiwayatPengangkatanModelList_LN() {
		return getPegawaiDetailCtrl_RiwayatPengangkatan().getRiwayatPengangkatanModelList_LN();
	}

	public void setRiwayatPengangkatanModelList_LN(
			BindingListModelList riwayatPengangkatanModelList_LN) {
		getPegawaiDetailCtrl_RiwayatPengangkatan().setRiwayatPengangkatanModelList_LN(riwayatPengangkatanModelList_LN);
	}
	...
	public HibernateSearchObject<TrMutasi> getSearchObj() {
		return searchObj;
	}

	public void setSearchObj(HibernateSearchObject<TrMutasi> searchObj) {
		this.searchObj = searchObj;
	}

	public TrMutasi getSelectedPangkat() {
		return selectedPangkat;
	}

	public void setSelectedPangkat(TrMutasi selectedPangkat) {
