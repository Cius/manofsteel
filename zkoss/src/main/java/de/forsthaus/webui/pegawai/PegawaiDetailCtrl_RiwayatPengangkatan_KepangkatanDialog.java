 ...
 * /WEB-INF/pages/sec_right/kepangkatanDialog.zul file.<br>
 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++<br>
 * 
 ...
 * @author sgerth
 */
public class PegawaiDetailCtrl_RiwayatPengangkatan_KepangkatanDialog extends GFCBaseCtrl implements Serializable {

	private static final long serialVersionUID = -546886879998950467L;
	private static final Logger logger = Logger.getLogger(PegawaiDetailCtrl_RiwayatPengangkatan_KepangkatanDialog.class);
	 ...
	 * ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	 */
	protected Window kepangkatanDialogWindow; // autowired
	...
	private transient Listbox listBoxKepangkatan; // overhanded
	...
	private transient final String btnCtroller_ClassPrefix = "button_KepangkatanDialog_";
	 ...
	 */
	public PegawaiDetailCtrl_RiwayatPengangkatan_KepangkatanDialog() {
		super();
	}
	 ...
	 * @throws Exception
	 */
	public void onCreate$kepangkatanDialogWindow(Event event) throws Exception {
		...
		if (args.containsKey("listbox")) {
			listBoxKepangkatan = (Listbox) args.get("listbox");
		} else {
			listBoxKepangkatan = null;
		}
	 ...
	 * @throws Exception
	 */
	public void onClose$kepangkatanDialogWindow(Event event) throws Exception {
...
//	}
	...
	public void onClick$btnClose(Event event) throws InterruptedException {
		...
		try {
			...
			// close anyway
			kepangkatanDialogWindow.onClose();
		}
	}
	...
	public void doShowDialog(TrKgbPangkat pangkat) throws InterruptedException {
		...
		try {
			...
			kepangkatanDialogWindow.doModal(); // open the dialog in modal
			// mode
		} catch (final Exception e) {
	...
	/**
	 * Deletes a kepangkatan object from database.<br>
	 * 
	 * @throws InterruptedException
	 */
	private void doDelete() throws InterruptedException {
		...
		if (MultiLineMessageBox.show(msg, title, MultiLineMessageBox.YES | MultiLineMessageBox.NO, MultiLineMessageBox.QUESTION, true, new EventListener() {
			...
			private void delete() throws InterruptedException {
				...
				final ListModelList lml = (ListModelList) listBoxKepangkatan.getListModel();
				...
				kepangkatanDialogWindow.onClose(); // close
			}
		}
	...
	/**
	 * Create a new kepangkatan object. <br>
	 */
	private void doNew() {
	...
	public void doSave() throws InterruptedException {
		...
		// now synchronize the listBox
		ListModelList lml = (ListModelList) this.listBoxKepangkatan.getListModel();
