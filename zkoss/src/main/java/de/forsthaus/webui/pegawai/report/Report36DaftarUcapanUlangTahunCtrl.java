...
public class Report36DaftarUcapanUlangTahunCtrl extends GFCBaseCtrl implements Serializable {
	...
	public Report36DaftarUcapanUlangTahunCtrl() {
		super();
	}
	...
	public void onClick$btnCari(Event event) throws InterruptedException {
		try{
			...
			listTbMaster = TbMasterDAO.getDaftar36UlangTahun(criterias);
			...
			report.setSrc("/reports/36daftar_ulang_tahun.jasper");
	...
	private String composeTitle() {
		...
		String title = "DAFTAR NOMINATIF PNS YANG BERULANG TAHUN PADA BULAN ";
