 ...
 * @author sgerth
 */
public class PegawaiDetailCtrl_RiwayatPengangkatan_JabatanDialog extends GFCBaseCtrl implements Serializable {

	private static final long serialVersionUID = -546886879998950467L;
	private static final Logger logger = Logger.getLogger(PegawaiDetailCtrl_RiwayatPengangkatan_JabatanDialog.class);
	 ...
	 */
	public PegawaiDetailCtrl_RiwayatPengangkatan_JabatanDialog() {
		super();
	}
