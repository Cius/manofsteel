...
public class Report15DaftarPendidikanUmumTerakhirCtrl extends GFCBaseCtrl implements Serializable {
	...
	String [] arrPendidikan = {"SLTA"};
	String [] arrKodePendidikan = {"1"};
	String [][] arrSubPendidikan = {{"SEKOLAH MENENGAH ATAS"}};
	String [][] arrKodeSubPendidikan = {{"1"}};

	private TbMasterDAO TbMasterDAO;
	private MasterUnitKerjaDAO masterUnitKerjaDAO;

	public Report15DaftarPendidikanUmumTerakhirCtrl() {
		super();
	}
	...
	public void onClick$btnCari(Event event) throws InterruptedException {
		...
		listTbMaster = TbMasterDAO.getDaftar15PendidikanUmumTerakhir(criterias);
		...
		report.setSrc("/reports/15daftar_pendidikan_umum_terakhir.jasper");
