 ...
 */
package de.forsthaus.webui.diklatjabatan.model;
 ...
 * 
 */
public class DiklatJabatanListModelItemRenderer implements ListitemRenderer, Serializable {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(DiklatJabatanListModelItemRenderer.class);
	...
	public void render(Listitem item, Object data) throws Exception {
		...
		ComponentsCtrl.applyForward(item, "onDoubleClick=onDoubleClickedDiklatJabatanItem");
